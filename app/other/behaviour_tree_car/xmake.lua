...
target("behaviour_tree_test")
    ...
    do -- [Test Cases]
        ...
        add_tests("test_repeat", {runargs = {"--test_file", "test/test_repeat.xml"}, run_timeout = 1000, pass_outputs = "11111"})
        add_tests("test_sequence_repeat", {runargs = {"--test_file", "test/test_sequence_repeat.xml"}, run_timeout = 1000, pass_outputs = "!11111!"})
        ...
        add_tests("test_sequence_double_repeat", {runargs = {"--test_file", "test/test_sequence_double_repeat.xml"}, run_timeout = 1000, pass_outputs = "!11111!11111"})
        add_tests("test_sequence_repeat_double", {runargs = {"--test_file", "test/test_sequence_repeat_double.xml"}, run_timeout = 1000, pass_outputs = "!1111111111111111111111111!"})
    end